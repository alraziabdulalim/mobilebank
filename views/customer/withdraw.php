      ...
      <nav class="border-b border-emerald-300 border-opacity-25 bg-emerald-600"
            ...
            <div class="flex items-center px-2 lg:px-0">
              <div class="hidden sm:block">
                <div class="flex space-x-4">
                  ...
                  <a href="../customer"
                    class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium">Dashboard</a>
                  <a href="./deposit"
                    class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium">Deposit</a>
                  <a href="./withdraw" class="bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium"
        ...
        <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
          <div class="space-y-1 pt-2 pb-3">
            <a href="../customer"
              class="text-white hover:bg-emerald-500 hover:bg-opacity-75 block rounded-md py-2 px-3 text-base font-medium">Dashboard</a>
            <a href="./deposit"
                ...
                <input type="hidden" name="balance" value="<?= htmlspecialchars($balance); ?>">
                  ...
                  <div class="relative mt-2 rounded-md">
                    ...
                    <input type="number" name="amount" id="amount"
                      value="<?= isset($request['amount']) ? $request['amount'] : ''; ?>"
