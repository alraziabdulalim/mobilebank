...
<div class="sm:rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        <div class="mt-4 text-sm text-gray-500">
            <form action="/create-transfer" method="POST" novalidate>
                ...
                <div class="relative mt-4 md:mt-8">
                    ...
                    <input type="number" name="amount" id="amount"
                        ...
                        class="block w-full ring-0 outline-none pl-4 py-2 md:pl-8 text-gray-800 border-b border-b-emerald-500 placeholder:text-gray-400 md:text-4xl" placeholder="0.00" required="">
