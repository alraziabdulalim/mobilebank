  ...
  <div class="flex flex-col justify-center min-h-full py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="px-6 py-12 bg-white shadow sm:rounded-lg sm:px-12">
        ...
        <form class="space-y-6" action="./auth/verify" method="POST">
          <div>
            <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email address</label>
            <div class="mt-2">
              <input id="email" name="email" type="email" autocomplete="email"
                value="<?= isset($request['email']) ? $request['email'] : ''; ?>" required
          ...
          <div>
            ...
            <div class="mt-2">
              ...
              <div class="text-red-400">
                ...
                <?= isset($errors) && !isset($errors['password']) ? 'Please, re-enter your password.' : ''; ?>
              </div>
            </div>
          </div>
      ...
      <p class="mt-10 text-sm text-center text-gray-500">
        ...
        <a href="./register" class="font-semibold leading-6 text-emerald-600 hover:text-emerald-500">Register</a>
      </p>
    </div>
  </div>
</body>
