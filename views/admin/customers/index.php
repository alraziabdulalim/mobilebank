                    ...
                    <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                      <div class="flex gap-x-4">
                        <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-sky-500">
                          <span
                            class="text-xl font-medium leading-none text-white"><?= htmlspecialchars($user['name']); ?></span>
                        </span>
                        ...
                        <div class="flex-auto min-w-0">
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a href="./customer_transactions"
                              class="relative truncate hover:underline"><?= htmlspecialchars($user['email']); ?></a>
                          </p>
                        </div>
                        <!-- Status Line START -->
                        <?php if (htmlspecialchars($user['auth_permit'] ?? '') != '') { ?>
                          <span class="inline-flex items-center justify-center h-6 rounded-md bg-green-500 px-3">
                            <span class="text-sm font-medium leading-none text-white">Approved</span>
                          </span>
                        <?php } else { ?>
                          <span class="inline-flex items-center justify-center h-6 rounded-md bg-orange-500 px-3">
                            <span class="text-sm font-medium leading-none text-white">Approval Pending</span>
                          </span>
                        <?php } ?>
                        <!-- Status Line END -->
                        <!-- Approval Line START -->
                        <?php if (htmlspecialchars($user['auth_permit'] ?? '') == '') { ?>
                          <form method="POST" action="/admin/customers/update">
                            ...
                            <button type="submit" name="auth_permit" value="is_Permit"
                              ...
                              <span class="text-sm font-medium leading-none text-white">Approved::YES</span>
                            </button>
                            ...
                            <button type="submit" name="auth_permit" value="cancel"
                              ...
                              <span class="text-sm font-medium leading-none text-white">Approved::CANCEL</span>
                            </button>
                          </form>
                        <?php } ?>
                        <!-- Approval Line END -->
